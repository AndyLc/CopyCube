...
public class CameraSmoothFollow : MonoBehaviour
{
	...
	void Update()
	{
		...
		if (cameraFollowY)
		{
			thisTransform.position = new Vector3(thisTransform.position.x, Mathf.SmoothDamp(thisTransform.position.y, cameraTarget.transform.position.y + 2f, ref velocity.y, smoothTime), thisTransform.position.z);
		}
