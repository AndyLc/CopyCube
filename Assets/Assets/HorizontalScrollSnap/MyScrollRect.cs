...
{
    [AddComponentMenu("UI/My Scroll Rect", 33)]
    [SelectionBase]
    [ExecuteInEditMode]
    [RequireComponent(typeof(RectTransform))]
    public class MyScrollRect : UIBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollHandler, ICanvasElement
    {
        ...
        public virtual void OnEndDrag(PointerEventData eventData)
        {
            ...
            m_Dragging = false;
            gameObject.GetComponent<HorizontalScrollSnap>().DragEnd();
        }
        ...
        public virtual void OnDrag(PointerEventData eventData)
        {
            ...
            gameObject.GetComponent<HorizontalScrollSnap>().OnDrag();
